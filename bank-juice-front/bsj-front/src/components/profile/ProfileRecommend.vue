<template>
  <div class="search-div">
    <div class="d-flex flex-column align-items-center">
      <div class="container profile-recommend">
        <div v-if="depositsLength">
          <p class="mt-5 mb-3 product-title">예금</p>
          <div v-for="deposit in store.recommend_user_deposits">
        ...
        <div v-if="savingsLength">
          ...
          <div v-for="savings in store.recommend_user_savings">
            <div class="card my-2 p-4 card-div">
              <div class="d-flex flex-row justify-content-between">
                <div class="d-flex flex-column justify-content-between">
                  <div>
        ...
        <div v-if="personalsLength">
          ...
          <div v-for="personal in store.recommend_user_personals">
            <div class="card my-2 p-4 card-div">
              <div class="d-flex flex-row justify-content-between">
                <div class="d-flex flex-column justify-content-between">
                  <div>
        ...
        <div v-if="mortgagesLength">
          ...
          <div v-for="mortgage in store.recommend_user_mortgages">
            <div class="card my-2 p-4 card-div">
              <div class="d-flex flex-row justify-content-between">
                <div class="d-flex flex-column justify-content-between">
                  <div>
        ...
        <div v-if="jeonsesLength">
          ...
          <div v-for="jeonse in store.recommend_user_jeonses">
            <div class="card my-2 p-4 card-div">
              <div class="d-flex flex-row justify-content-between">
                <div class="d-flex flex-column justify-content-between">
                  <div>
...
const depositsLength = store.recommend_user_deposits.length
const savingsLength = store.recommend_user_savings.length
const personalsLength = store.recommend_user_personals.length
const mortgagesLength = store.recommend_user_mortgages.length
const jeonsesLength = store.recommend_user_jeonses.length
...
onMounted(() => {
  store.recommended_deposit()
  store.recommended_savings()
  store.recommended_personal()
  store.recommended_mortgage()
  store.recommended_jeonse()
})
</script>
